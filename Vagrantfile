...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :central do |central_config|
    ...
    central_config.vm.provision :puppet do |central|
      central.manifests_path = "manifests"
      central.manifest_file  = "central_config.pp"
    end
    
  end
###############################################################################
config.vm.define :shipper do |shipper_config|
  ...
  shipper_config.vm.provision :puppet do |shipper|
    shipper.manifests_path = "manifests"
    shipper.manifest_file  = "shipper_config.pp"
  end
